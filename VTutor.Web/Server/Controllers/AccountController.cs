...
using VTutor.Web.Server.Models.AccountViewModels;
...
namespace VTutor.Web.Server.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		{
			if (model.RegistrationType != "Tutors" && model.RegistrationType != "Students")
			{
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					await _userManager.AddToRoleAsync(user, model.RegistrationType);

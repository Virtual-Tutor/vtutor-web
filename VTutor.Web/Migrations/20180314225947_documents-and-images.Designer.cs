...
namespace VTutor.Web.Migrations
{
    ...
    [Migration("20180314225947_documents-and-images")]
    partial class documentsandimages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VTutor.Model.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("VTutor.Model.Tutor", b =>
                {
                    ...
                    b.Property<Guid?>("TutorImageId");

                    b.HasKey("Id");

                    b.HasIndex("TutorImageId");
            ...
            modelBuilder.Entity("VTutor.Model.ApplicationUser", b =>
                {
                    b.HasOne("VTutor.Model.Tutor", "Tutor")
                        .WithOne("User")
                        .HasForeignKey("VTutor.Model.ApplicationUser", "TutorId");
                });
            ...
            modelBuilder.Entity("VTutor.Model.Tutor", b =>
                {
                    b.HasOne("VTutor.Model.Image", "TutorImage")
                        .WithMany()
                        .HasForeignKey("TutorImageId");
                });
